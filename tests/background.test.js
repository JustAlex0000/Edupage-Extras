...
runTest("theme shortcut messages carry the complete current theme state", () => {
  ...
  assert.deepEqual(JSON.parse(JSON.stringify(message)), {
    ...
    hideLikesEnabled: true,
    hideEdupageHelpEnabled: true,
    hideEducationalGamesEnabled: true,
    hideTestYourselfEnabled: true,
    hideInteractiveBlackboardsEnabled: true,
    hidePhotosEnabled: true,
    hideRegistrationSurveysEnabled: true,
