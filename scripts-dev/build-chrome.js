#!/usr/bin/env node
/**
 * Builds the Chrome Web Store .zip. `browser_specific_settings` is Firefox-only
 * and triggers warnings, so this stages an allowlist of shippable paths into a
 * temp dir, removes that key, and zips it into web-ext-artifacts/ (same place
